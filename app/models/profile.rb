...
class Profile < ApplicationRecord
  ...
  has_many :buddyships, class_name: "Friendship", foreign_key: "buddy_id", dependent: :destroy
  ...
  def friends
    Profile.where(id: friendships.select(:buddy_id).accepted).or(Profile.where(id: buddyships.select(:friend_id).accepted))
  end
